...
// In a real app, this data comes from a server component + SWR or React Query.
...
export default function AdminSessionsPage() {
  ...
  // In real implementation: fetch selected session from API when selectedId changes.
  ...
  return (
    <main className="min-h-screen bg-gray-50 px-6 py-8">
      <div className="mx-auto max-w-6xl">
        ...
        <SessionDetailPanel
          session={null} // TODO: fetch when selected
