/**
 * POST /api/v1/professionals/[id]/services/bulk/delete — RETIRED, answers 410.
 *
 * Bulk unassign wrote to `wp_kc_service_doctor_mapping` without the upcoming-appointment check
 ...
 */
import { bulkDeleteRetired } from '@/services/professional/retired-endpoints';

export const POST = async () => bulkDeleteRetired();
